...
export const staticsticalApi = {
	...
	getUserStatus12Months(params) {
		return instance.get('/api/Statistical/user-status-12-month', { params })
	},
	getTotalSalary12Months(params) {
		return instance.get('/api/Statistical/total-salary-12-month', { params })
	},
	getTotalSalaryByTeacher(params) {
		return instance.get('/api/Statistical/total-salary-by-teacher', { params })
	}
}
