...
type TSampleEvaluationGroupOption = {
	SampleEvaluationFormId: number
	SampleEvaluationGroupId: number
	Content: string
	Point: number
...
type TPostSampleEvaluationGroupOption = {
	SampleEvaluationGroupId: number
	Content: string
	Point: number
}

type TPutSampleEvaluationGroupOption = {
	Content: string
	Point: number
	Id: number
}

type TChangeIndexSampleEvaluationGroupOption = {} & TChangeIndexSampleEvaluationGroup
