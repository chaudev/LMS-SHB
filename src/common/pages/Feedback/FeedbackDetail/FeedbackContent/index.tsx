...
import { Card, Divider, Empty, Modal, Skeleton } from 'antd'
import React, { useState } from 'react'
import { FiCalendar } from 'react-icons/fi'
import { feedbackApi } from '~/api/feedback-list'
import PrimaryButton from '~/common/components/Primary/Button'
import PrimaryTag from '~/common/components/Primary/Tag'
import { getBase64, ShowNostis } from '~/common/utils'
...
const FeedbackContent: React.FC<IFeedbackContent> = (props) => {
	...
	return (
		<>
					...
					<div className="py-3 px-3">
						...
						<div className="mt-5 mb-10">
							<div className="flex gap-4 flex-wrap items-center">
								...
								{!!data?.RoomImages?.length && <div className='mr-8'>
									<p className="text-[16px] font-semibold mb-[8px] text-gray-500">Hình ảnh:</p>
									...
									>
										{data?.RoomImages.map((image, index) => <Image
											...
											className='rounded border-[1px] border-solid border-[#dedede]'
										/>)}
									</Image.PreviewGroup>
									</div>
								</div>}
			...
			<Modal visible={previewOpen} title={""} footer={null} onCancel={handleCancel} width={1200}>
